...
from plot_performance_lunges import plotgraph
            ...
            if ret:
                ...
                if curltracker:
                    for idx in range(output.shape[0]):
                        ...
                        bar = np.interp(angle, (105, 166), (200, fh-100)) # hypers: bar = np.interp(angle, (20, 150), (200, fh-100))
                        ...
                        if percentage == 0:
                            if direction == 1:
                                ...
                                if max_percentage <= 75:
                                    feedback = "Please go more down! Engage your gultes." if recommendation else ""
