...
@torch.no_grad()
def run_shoulder_lateral_raise(poseweights='yolov7-w6-pose.pt', source='static/uploads/bicep.mp4', device='cpu', curltracker=True, drawskeleton=True, recommendation = False):
    ...
    if ext in ["mp4", "webm", "avi"] or ext not in ["mp4", "webm", "avi"] and ext.isnumeric():
        ...
        out_video_name = "D:\\yolov7\\static\\uploads\\output_shoulder" if path.isnumeric(
        ) else "D:\\yolov7\\static\\uploads\\output_shoulder"
